...
<Step title="Open the Create View">
  Open the command bar (`Cmd/Ctrl + K`) and select **New Workspace**. You can also start one from the **Workspaces dashboard** or from an issue's **Workspaces** section.

  <Frame>
  <img style={{maxHeight: "300px"}} src="/images/workspaces-sidebar-create-button.png" alt="The create-workspace view" />
  </Frame>
</Step>
