...
<Frame>
<img style={{maxHeight: "400px"}} src="/images/workspaces-overview.png" alt="Workspaces view showing the global sidebar with the conversation, changes, and details panels" />
</Frame>
