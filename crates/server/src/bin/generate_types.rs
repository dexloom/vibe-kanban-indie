...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::requests::CreateSpecKitFeatureRequest::decl(),
        db::models::requests::CreateSpecKitFeatureResponse::decl(),
        ...
        api_types::RunStageRequest::decl(),
        api_types::RunStageResponse::decl(),
