...
struct PipelineStep: Identifiable, Hashable {
    ...
    static let defaults: [PipelineStep] = [
        ...
        .init(id: "wait-for-approval", label: "Wait for approval",
              ...
              defaultEnabled: false),
        .init(id: "code-review", label: "Review code",
              promptFragment: "After implementing, run a code review on the diff and address findings before marking the card ready.",
              defaultEnabled: false),
